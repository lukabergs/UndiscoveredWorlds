...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Land mask aligned to the climate grid; the legacy default was removed",
    )
    parser.add_argument(
        "--reference",
        type=Path,
        required=True,
        help="Categorical Koppen reference aligned to the climate grid",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("out/observed-climate"),
    )
