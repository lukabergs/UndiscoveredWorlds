...
const uint8_t* platec_api_get_surface_crust_type_map(void*);
...
const float* platec_api_get_tension_map(void*);
...
uint32_t platec_api_get_tectonic_junction_count(void*);
const platec::contract::TectonicJunction* platec_api_get_tectonic_junctions(void*);
const uint8_t* platec_api_get_material_map(void*);
...
uint8_t platec_api_is_oceanic_plate(void*, uint32_t plate_index);
