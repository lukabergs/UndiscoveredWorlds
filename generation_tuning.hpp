...
inline constexpr float stationaryThermalNonlocalResponseFraction = 0.50f;
inline constexpr float stationaryThermalLongitudinalReachHadleyFraction = 1.0f;
inline constexpr float stationaryThermalMeridionalReachHadleyFraction = 0.40f;
